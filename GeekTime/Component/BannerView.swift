...
class BannerView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    static let cellId = "bannerViewCellId"
    ...
    @objc func flipNext() {
        ...
        let currentPageNumer = Int(round(collectionView.contentOffset.x/collectionView.frame.width))
          
        if isInfinite {
            let nextPageNumber = currentPageNumer + 1
            ...
            var nextPageNumber = currentPageNumer + 1
